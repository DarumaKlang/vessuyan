      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="glass-lg rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm">เข้าร่วม Vessuyan เพื่อค้นพบดวงชะตา</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0f0a1c] text-gray-400">หรือสมัครสมาชิกด้วย</span>
            </div>
          </div>
          ...
          <p className="text-center text-gray-300 text-sm mt-6">
            มีบัญชีแล้ว?{' '}
            <Link href="/auth/signin" className="text-secondary-gold hover:text-secondary-gold/80 font-medium transition">
              เข้าสู่ระบบ
            </Link>
          </p>
        </div>
